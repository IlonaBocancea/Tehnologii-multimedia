...
document.addEventListener('DOMContentLoaded', function () {
    ...
    ctx.stroke();
    //----------------------------------------------
    var w = document.querySelector('.clmn');
    var html_text = '<table id="teb" class="table table-bordered"><tr><td>Semestru</td>';
    html_text += '';
    for (var i = 0; i < b.length; i++) {
    ...
    //----------------------------------------------
    var precedent_key = 0;
    var element = document.querySelector('#teb');
